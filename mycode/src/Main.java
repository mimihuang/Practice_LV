...
public class Main {  
    ...
    public static void main(String[] args) throws IOException {  
        ...
        a.init("/Users/tcslab/PCA_alg/Louvain/facebook_combined.txt");  
        a.louvain();  
        double endTime = System.currentTimeMillis();  
        //writeOutputJson("/var/www/html/Louvain/miserables.json", a);   
        writeOutputCluster("/Users/tcslab/PCA_alg/Louvain/cluster.txt",a);  //print every nodes belonging to which clusters 
        writeOutputCircle("/Users/tcslab/PCA_alg/Louvain/circle.txt",a);   //print every clusters containg which nodes
